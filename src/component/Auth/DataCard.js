...
const DataCard = ({ email }) => {
  ...
  const { setIsLoggedin, setLoginWithCard, setShowData, link } = store()
  ...
  return (
    <div className='w-[100vw] h-[100vh] flex items-center justify-center bg-overlay fixed top-0 left-0 z-30'>
      ...
      <img src={Arrow} alt="" className="p-[6px] bg-[#F2F1E8] hover:bg-[#CCC8A4] ml-0 w-6 h-6" onClick={returnToEmailCard}/>
        ...
        <div className="tablet:flex gap-6 w-full">
          <div className="text-left flex flex-col">
            <label htmlFor="email" className="text-16 font-medium mb-2">First name</label>
          ...
          <div className="text-left flex flex-col">
            <label htmlFor="email" className="text-16 font-medium mb-2">Last name</label>
        ...
        <div className="text-left flex flex-col">
          <label htmlFor="email" className="text-16 font-medium mb-2">Username</label>

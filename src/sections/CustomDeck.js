...
const CustomDeck = () => {
  return (
    <div className={`bg-[#03331B] text-white`}>
      ...
      <h1 className='text-32 font-bold tablet:text-48 mb-2'>Transform your product idea into a compelling pitch deck for fundraise</h1>
      <h2 className={`text-16 tablet:text-20 mb-10 w-[80%] mx-auto`}>Our expertly crafted pitch deck is designed to support you in raising capital for your business. Get started making one today starting at $299</h2>
        <HashLink smooth to='/make-deck/#pricing'
          ...
          Get a custom deck starting at $299</HashLink>
      </div>
    </div>
    </div>

...
const Hero = () => {
  return (
    <div className='bg-[#F2F1E8] '>
      ...
      <p className='text-[32px] font-bold leading-[39px] tracking-[-1px] tablet:text-[48px] tablet:leading-[40px] laptop:text-[64px] laptop:leading-[72px] laptop:tracking-[-2px] text-[#2E2E27] mb-6 font-san'>Beautiful powerpoint presentation for your next project</p>
      <p className='text-[16px] leading-6 tablet:text-[20px] tablet:leading-[28px] laptop:text-[24px] laptop:leading-8 text-[#64645F] mb-[40px]'>Pptdesigner supports your business to design beautiful powerpoint slides for your next presentation to get the numbers</p>
        <HashLink smooth to='/#pricing'
          ...
          Design a presentation</HashLink>
      </div>
    </div>
    </div>

...
const Testimonials = () => {
  ...
  const testimonies = [
    ...
    // {rating: 5, name: "Dike Goodluck", title: "Founder , instantApply.co ", message:"I've struggled getting interests from investors with previous  pitch deck I used for my new startup , but since I came across pitch deck and utilized their templates, I have been getting positive responses from investors"},
    // {rating: 5, name: "Awo Bangalee", title: "Founder, The Bright Millennial", message:"Pitchdeck.design is something that i would highly recommend. It made us look a lot better in our clients’ eyes because it’s something that’s visually effective as a marketing tool."},
  ]
    ...
    <div className='bg-[#F2F1E8]'>
      <div className='w-full laptop:max-w-[1152px] mx-auto px-4 tablet:px-6 laptop:px-8 xl:px-0 py-[40px] tablet:py-[80px] laptop:py-[100px]'>
        <div className='flex flex-col gap-[13px] pb-5 tablet:pb-10 laptop:pb-[50px] '>
          <h2 className='text-center text-[#2E2E27] text-[24px] font-bold leading-8 tracking-[-0.96px] tablet:text-[32px] tablet:leading-[39px] tablet:tracking-[-1px] laptop:text-[48px] laptop:leading-[40px]'>What our customers are saying</h2>
          <p className='text-center text-[#2E2E27] text-[20px] leading-8 tracking-[-0.96px] laptop:w-[831px] mx-auto'>Find out from people who love our product, they love using us to Make their deck and 
find pitchdeck inspiration</p>
        </div>

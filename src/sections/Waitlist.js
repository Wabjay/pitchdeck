...
const Waitlist = () => {
  return (
   ...
   <p className='text-[32px] font-bold leading-[39px] tracking-[-1px] md:text-[48px] md:leading-[40px] lg:text-[64px] lg:leading-[72px] lg:tracking-[-2px] text-[#FFF] mb-6'>Ready to start creating presentation</p>
   <p className='text-[16px] leading-6 md:text-[20px] md:leading-[28px] lg:text-[24px] lg:leading-8 text-[#FFF] mb-[40px]'>Subscribe and see how we turn your presentation  into wonderful visuals</p>
     <a href="#"
